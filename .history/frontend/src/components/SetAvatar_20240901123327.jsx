...
// //             `${api}/${Math.round(Math.random() * 1000)}`
// //           );
// //           data.push(image.data); // Directly use image.data if it's already a base64 string
// //         }
// //         setAvatars(data);
// //         setIsLoading(false);
// //       } catch (error) {
...
//                 <img
//                   id="avatar-img"
//                   src={`data:image/png;base64,${avatar}`} // Assuming the image is PNG
//                   alt="avatar"
//                   onClick={() => setSelectedAvatar(index)}
//                 />
//               </div>
          ...
          <div className="avatars">
            {avatars.map((avatar, index) => (
              ...
              >
                <img
                  id="avatar-img"
                  src={avatar} // Directly use base64 string
                  alt="avatar"
                  onClick={() => setSelectedAvatar(index)}
                />
              </div>
